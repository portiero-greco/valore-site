...
export function BoatInsurancePage() {
  const { t } = useLanguage();
  const category = t?.individualSolutions?.categories?.boatInsurance;
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-green-50/30 to-gray-50">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="mb-12 relative">
          <div className="absolute -left-4 top-0 w-1 h-20 bg-gradient-to-b from-green-600 to-green-400 rounded-full" />
        ...
        <div className="relative w-full aspect-[21/9] rounded-2xl overflow-hidden mb-16 shadow-2xl group">
          ...
          <img
            src="https://images.unsplash.com/photo-1569263979104-865ab7cd8d13?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=1080"
            alt={category.title}
