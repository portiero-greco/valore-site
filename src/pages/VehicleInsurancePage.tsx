...
export function VehicleInsurancePage() {
  const { t } = useLanguage();
  const category = t.individualSolutions.categories.vehicleInsurance;
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-green-50/30 to-gray-50">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="relative w-full aspect-[21/9] rounded-2xl overflow-hidden mb-16 shadow-2xl group">
          ...
          <ImageWithFallback
            src="https://images.unsplash.com/photo-1678796107506-639fca898022?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxjYXIlMjB2ZWhpY2xlJTIwZmFtaWx5fGVufDF8fHx8MTc2MjYxMDIyNXww&ixlib=rb-4.1.0&q=80&w=1080"
            alt={category.title}
